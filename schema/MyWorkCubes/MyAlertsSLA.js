...
cube(`MyAlertsSLA`, {
	sql: `SELECT DISTINCT(CONCAT(_id, ugId)), _id, tenantId, status, created, ugId, owners FROM(SELECT * FROM(SELECT * FROM (SELECT _id, tenantId, status, created FROM ${alertsCollection} where ${alertsCollection}.archived=0) as alerts LEFT JOIN 
